...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{DBAUTHTEST_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{DBAUTHTEST_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
dbauthtest_server.pl - Catalyst Testserver

=head1 SYNOPSIS

dbauthtest_server.pl [options]
